...
sudo scutil --set ComputerName "bb-8"
sudo scutil --set HostName "bb-8"
sudo scutil --set LocalHostName "bb-8"
...
launchctl unload -w /System/Library/LaunchAgents/com.apple.notificationcenterui.plist 2> /dev/null 2>&1
